        ...
        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
          ...
          <div className="relative shrink-0 w-full">
            <div className="content-stretch flex flex-col gap-[24px] items-start px-[16px] py-[8px] relative w-full">
              ...
              <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                <Dropdown
                  label="Apply to Item Condition"
                  options={conditions}
                  value={condition}
                  onChange={(val) => onUpdateCondition?.(val)}
                />
              </div>
              ...
              <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                <Dropdown
                  label="Apply to Shop / Branch"
                  options={shops.map(s => ({ label: s, value: s }))}
                  value={shop}
                  onChange={(val) => onUpdateShop(val)}
                />
              </div>
