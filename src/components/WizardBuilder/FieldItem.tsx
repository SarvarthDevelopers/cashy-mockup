    ...
    <div className="fi-section">
      ...
      <div className="fi-section__fields">
        <div className="fi-field-group">
          ...
          <input className="fi-input" value={field.label} onChange={(e: React.ChangeEvent<HTMLInputElement>) => onUpdate(field.id, { label: e.target.value })} />
        </div>
        <div className="fi-field-group">
          <label className="fi-label">Help Text / Description</label>
          <input className="fi-input" value={field.helpText ?? ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => onUpdate(field.id, { helpText: e.target.value })} />
        </div>
      </div>
    </div>
      ...
      <div className="fi-section">
        ...
        <div className="fi-section__fields fi-section__fields--cols2">
          ...
          <div className="fi-field-group">
            ...
            <input className="fi-input" value={field.defaultValue ?? ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => onUpdate(field.id, { defaultValue: e.target.value })} />
          </div>
          <div className="fi-field-group">
            <label className="fi-label">Min Length</label>
            <input className="fi-input" type="number" value={field.minLength ?? ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => onUpdate(field.id, { minLength: parseInt(e.target.value) || undefined })} />
          </div>
          <div className="fi-field-group">
            <label className="fi-label">Max Length</label>
            <input className="fi-input" type="number" value={field.maxLength ?? ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => onUpdate(field.id, { maxLength: parseInt(e.target.value) || undefined })} />
          </div>
        </div>
      </div>
    )}
    ...
    <div className="fi-section">
      ...
      <div className="fi-section__fields">
        ...
        <div className="fi-field-group">
          ...
          <input className="fi-input" value={field.buttonLabel ?? 'Upload file'} onChange={(e: React.ChangeEvent<HTMLInputElement>) => onUpdate(field.id, { buttonLabel: e.target.value })} />
        </div>
      </div>
    </div>
    <div className="fi-section">
      ...
      <div className="fi-section">
        ...
        <div className="fi-section__fields">
          ...
          <div className="fi-option-add">
            <input className="fi-input" value={newOption} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewOption(e.target.value)} onKeyDown={e => e.key === 'Enter' && (onUpdate(field.id, { options: [...options, newOption] }), setNewOption(''))} placeholder="Add option…" />
