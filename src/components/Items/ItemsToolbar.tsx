      ...
      <div className="flex flex-col gap-3 md:hidden w-full">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-[var(--text-primary)] leading-none tracking-tight">Items</h1>
      ...
      <div className="hidden md:flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div className="flex flex-1 items-center gap-4 min-w-0 flex-nowrap">
          <div className="flex items-center gap-2 shrink-0">
            <h1 className="text-2xl font-semibold text-[var(--text-primary)] leading-none tracking-tight">Items</h1>
